...
# If you want to point at a table, then you just add the key that points to
# that table as a value from your AllBookTables dictionary. It basically
...
# tableRoom will replace tableRoomsInDungeon and the result will end up being
# something like "[RandomValueFromRoomTable]sInDungeon"
# Because of the same quirk with the code you cannot have more than one
# instance of a reference to another table
tableAnotherthing = {
    0: "Another thing",
    1: "another thing 1"
    2: "another thing 4"
    ...
    4: "tableLetters powerfull"
    # This will not work as expected and will result in the second reference
    # being the same as the first one. This could perhaps be taken advantage
    # of!
    4: "tableLetters tableLetters"
    # You cna have "Roll Again"s by referencing this tables self.
    4: "tableAnotherthing"
    5: ""
    6: ""
    7: ""
...
tableSecretRooms = {
    ...
    1: "\n(This is room tableLetters with tableAnything in it. "
       + "Something with a 1/6 chance of happening in this config: tableThree)",
    2: "\n(This is room tableLetters with "
...
presetCustomDungeon = {
    0: "CustomDungeon",
    1: "A tableThree dungeon with the following rooms: "
       + "tableSecretRooms tableSecretRoomAmount."
    }

# Any tables you make should be added to this list
AllBookTables = {
        "tableLetters": tableLetters,
        "tableAnotherthing": tableAnotherthing
    }

# Any tables you need but dont want to be printed and available when using the
# command should be put here
AllSecretTables = {
        "tableSecretRooms": tableSecretRooms,
        "tableSecretRoomAmount": tableSecretRoomAmount,
    }

# All your presets added here
AllPresets = {
        "presetCustomDungeon": presetCustomDungeon,
    }
